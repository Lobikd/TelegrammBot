...
import org.example.question.HttpQuestion;
...
public class Bot extends TelegramLongPollingBot {
    ...
    public String getBotUsername() {
        return "LobachevJavaTestBot";
    }

    @Override
    public String getBotToken() {
        return "6541613024:AAE8KuGNQmaKjCt3uBZFPJgRqEtUE081vfI";
    }
    ...
    public void onUpdateReceived(Update update) {
        ...
        if (text.equals("/start")) {
            ...
            sendText(userId, "Тест окончен. Для перезапуска используйте команду /start");
        } else {
